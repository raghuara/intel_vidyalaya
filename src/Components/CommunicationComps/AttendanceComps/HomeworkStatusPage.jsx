...
import { fetchHomeworkStatus, homeworkStatusReport, postHomeworkStatus, updateHomeworkStatus } from '../../../Api/Api';
...
export default function HomeworkStatusPage() {
    ...
    const visibleData = selectedFilter
        ? homeworkStatusData.filter((row) => {
            ...
            return selectedFilter === "Completed" ? status === 1 : status === 0;
        })
        : homeworkStatusData;
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            setHomeworkDoneSaved(res.data.homeworkDoneSaved);
            setHomeworkStatusData(res.data.homeworkStatusDetails)
                                ...
                                <TableRow key={row.id}>
                                    ...
                                    <TableCell sx={{ borderRight: 1, borderColor: "#E8DDEA", width: "200px" }}>
                                        <Autocomplete
                                            ...
                                            onChange={(e, newValue) => {
                                                const mappedValue = newValue === "Completed" ? 1 : 0;
                                                setStatuses((prev) => ({
                                                    ...prev,
