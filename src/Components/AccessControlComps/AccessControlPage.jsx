...
import GroupIcon from '../../Images/Icons/user.png';
...
export default function AccessControlPage() {
    ...
    const items = [
        { color: "#A749CC", icon: GroupIcon, text: "Users", bgColor: "#FBF9FC", iconBgColor: "#F7F0F9", path: 'users', intimation: newsIntimation },
